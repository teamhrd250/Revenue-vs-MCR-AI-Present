# BUILD: AI_PRESENTATION_ENGINE_36_STEP_2026_07_19
...
def _build_presentation_flow(ctx: dict) -> list[dict]:
    """Create a detailed 36-step executive presentation from active SEP data."""
    m = ctx.get("metrics", {})
    ...
    return [
        ...
        # 2. Revenue & Productivity — 6 steps
        ...
        # 3. Workforce Performance — 5 steps
        ...
        # 4. Capacity & Delivery Risk — 5 steps
        ...
        # 5. Strategic Decision Center — 6 steps
        ...
        # 6. Benchmark & Methodology — 3 steps
