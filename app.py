...
def _local_presenter_answer(question: str, ctx: dict, route: dict) -> str:
    ...
    # Local comparison fallback when API key is unavailable.
    # Extract years from the question and compare only values available in SEP history.
...
def render_ai_dashboard_focus(ctx: dict):
    ...
    with right:
        ...
        _render_presenter_visual(route, ctx, key_scope="dashboard_focus")
        if answer:
        ...
        with st.popover("🎙 AI Presenter", help="Presentasikan dashboard atau ajukan pertanyaan", use_container_width=False):
            ...
            with ask_tab:
                ...
                if st.session_state.ai_presenter_answer:
                    ...
                    _render_presenter_visual(route, ctx, key_scope="popover")
