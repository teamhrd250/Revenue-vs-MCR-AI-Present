...
def _render_presenter_visual(route: dict, ctx: dict, key_scope: str = "inline"):
    """Render AI focus chart with a unique Streamlit key per render location."""
    m = ctx["metrics"]
    focus = route.get("route")
    if focus == "capacity":
        ...
        st.plotly_chart(fig, use_container_width=True, key=f"ai_capacity_visual_{key_scope}")
    elif focus == "mcr":
        ...
        fig.update_layout(height=260, margin=dict(l=10, r=10, t=50, b=10))
        st.plotly_chart(fig, use_container_width=True, key=f"ai_mcr_visual_{key_scope}")
    else:
        df = pd.DataFrame({
        ...
        fig.update_layout(height=260, margin=dict(l=10, r=10, t=50, b=10))
        st.plotly_chart(fig, use_container_width=True, key=f"ai_summary_visual_{key_scope}")
