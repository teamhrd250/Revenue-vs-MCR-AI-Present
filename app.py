        ...
        with st.popover("🎙 AI Presenter", help="Presentasikan dashboard atau ajukan pertanyaan", use_container_width=False):
            ...
            with ask_tab:
                ...
                answer_mode = st.selectbox(
                    "Kedalaman jawaban",
                    ["Data Only", "Executive Analysis", "Deep Advisory"],
                    index=["Data Only", "Executive Analysis", "Deep Advisory"].index(st.session_state.get("ai_answer_mode", "Executive Analysis")),
                    key="ai_answer_mode_select",
                    help="Executive Analysis direkomendasikan untuk rapat manajemen; Deep Advisory untuk perbandingan dan analisis lebih mendalam.",
                )
                st.session_state.ai_answer_mode = answer_mode
                st.caption(
                    "Cakupan analisis dipilih otomatis oleh AI berdasarkan pertanyaan. "
                    ...
                    if not question:
                        ...
                        with st.spinner("Menganalisis data SEP V4..."):
                            answer = _openai_presenter_answer(
                                ...
                                st.session_state.get("ai_answer_mode", "Executive Analysis"),
