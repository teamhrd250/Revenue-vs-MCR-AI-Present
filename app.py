...
def _infer_answer_mode(question: str, route: dict | None = None) -> dict:
    ...
    executive_terms = [
        ...
        "layak", "perlu hiring", "perlu rekrut", "keputusan",
    ]
    factual_terms = [
    ...
    return {"mode": "Executive Analysis", "label": "Eksekutif",
            "reason": "Maksud pertanyaan belum eksplisit; mode eksekutif dipilih sebagai default aman."}
