# BUILD: AI_PRESENTATION_ENGINE_44_STEP_CONCEPT_INTRO_2026_07_19
...
def _openai_presenter_answer(question: str, ctx: dict, route: dict, api_key: str) -> str:
    ...
    prompt = (
        ...
        "langsung, objektif, dan hanya berdasarkan JSON data. Jangan mengarang angka. Jelaskan kondisi bisnis dan satu arah tindakan manajemen yang realistis. "
